%Use a reduced order approximation of the eigenfaces to reproduce various
%images
%
%Christopher Lum
%lum@uw.edu
...
for k=1:length(r_data)
    ...
    %Project x_train onto basis spanned by Utilde (AKA dot product x_train
    %with each column of Utilde).  This effectively evaluates how aligned
    %x_train is with each column (AKA eigenface) of Utilde
