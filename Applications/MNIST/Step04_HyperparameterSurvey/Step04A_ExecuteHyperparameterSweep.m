...
switch scenarioSelection
    case 1
        ...
        neuralNetworkFile   = [ReturnPathStringNLevelsUp(1),'\Step03_SetupNeuralNetwork\NeuralNetworkScenario1.mat'];
...
disp(['Loading neural network from ',neuralNetworkFile])
temp = load(neuralNetworkFile);
nn = temp.nn;
...
parsave(...
    outputFile,...
    nn,options,...
    trainingDataFile,neuralNetworkFile,...
